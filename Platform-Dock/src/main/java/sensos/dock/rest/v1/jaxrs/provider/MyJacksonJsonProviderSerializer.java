 ...
 */
package sensos.dock.rest.v1.jaxrs.provider;
...
@Singleton
public class MyJacksonJsonProviderSerializer implements ContextResolver<ObjectMapper> {
    ...
    public MyJacksonJsonProviderSerializer() {

        System.out.println("Initializing... " + MyJacksonJsonProviderSerializer.class.getName());
