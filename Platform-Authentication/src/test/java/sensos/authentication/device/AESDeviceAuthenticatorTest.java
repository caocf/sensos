...
public class AESDeviceAuthenticatorTest {
    ...
    public void testAuthenticate() throws Exception {
        ...
        AESDeviceKeyFactory keyFactory = new AESDeviceKeyFactory(dao);
         ...
         */
        Long deviceId = 1L;
        logger.log(Level.INFO, "Generate both private and public key. Store private key to database.");
        ...
        AESDeviceAuthenticator authenticator = new AESDeviceAuthenticator(dao);
