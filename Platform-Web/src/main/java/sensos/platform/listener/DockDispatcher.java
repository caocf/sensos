 ...
 * @author sensos
 */
public class DockDispatcher {
    

    private static InitialContext jndi;
    private static Logger l = Logger.getLogger(DockDispatcher.class.getName());
    ...
    @Resource(name = JmsConstants.QUEUE_DOCK)
    private Queue queue;
    
    @PostConstruct
    void init() {

        l.log(Level.INFO, "Initializing {0}...", DockDispatcher.class.getName());

        try {

            jndi = new InitialContext();
            queue = (Queue) jndi.lookup("openejb:Resource/" + JmsConstants.QUEUE_DOCK);
...
*/
            ...
            Logger.getLogger(DockDispatcher.class.getName()).log(Level.SEVERE, null, ex);
        } 
    ...
    public void destroy() {
        ...
        l.log(Level.INFO, "Closing {0}...", DockDispatcher.class.getName());
